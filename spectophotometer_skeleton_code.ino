...
void setup() // initialize settings
{
   ...
   (32, BYTE), Serial.print(32, BYTE), Serial.print(32, BYTE), Serial.print(32, BYTE), Serial.print(32, BYTE), Serial.print(26, BYTE), Serial.print(26, BYTE); //
   reboot display
...
void loop() {
   ...
   for (;;) { // wait for button press
      ...
      if (redState == LOW) {
         goto transmission;
      } // on red button press jump to
      transmission subroutine
      if (blackState == LOW) {
         goto reflection;
      } // on black button press jump to reflection
      subroutine
   }
...
for (;;) { // wait for button press
   ...
   if (blackState == LOW) {
      goto reflection;
   } // on black button press jump to relection
   subroutine
}
}